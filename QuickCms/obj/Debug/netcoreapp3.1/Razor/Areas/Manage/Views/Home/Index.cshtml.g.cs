#pragma checksum "E:\class\19\QuickCms\Areas\Manage\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "54cf115619d7f5a28f4a96c17cfc04a2f8ef6036"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"54cf115619d7f5a28f4a96c17cfc04a2f8ef6036", @"/Areas/Manage/Views/Home/Index.cshtml")]
     ...
     ");
        ...
        ");
            WriteLiteral(@"            <div class=""card-block text-center"">
                    ...
                    <button class=""btn");
            WriteLiteral(@" btn-warning btn-block p-t-15 p-b-15"">Download Overall Report</button>
                </div>
            </div>
            <!--  sale analytics end -->
                                            ...
                                            <div class=""chk-option"">
                                                <div class=""checkbox-fade fade-in-primary"">
                                                    <label class=""check-task"">
                                                        <input type=""checkbox""");
            BeginWriteAttribute("value", " value=\"", 7620, "\"", 7628, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                        <span class=""cr"">
            ...
            WriteLiteral(@">
                                        ...
                                        <td>$53</td>
                      ");
            WriteLiteral(@"                  <td class=""text-c-blue"">$15,652</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class=""chk-option"">
            ...
            WriteLiteral(@">
                                        ...
                                        <td>$35</td>
                          ");
            WriteLiteral(@"              <td class=""text-c-blue"">$18,785</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class=""chk-option"">
                                                <div class=""checkbox-fade fade-in-primary"">
                                                    <label class=""check-task"">
                                                        <input type=""checkbox""");
            BeginWriteAttribute("value", " value=\"", 12004, "\"", 12012, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                        <span class=""cr"">
                                                            <i class=""cr-icon feather icon-check txt-default""></i>
                                        ...
                                        <td>$98</td>
                        ");
            WriteLiteral(@"                <td class=""text-c-blue"">$9,652</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class=""chk-option"">
            ...
            WriteLiteral(@">
                                        ...
                                        <td>$20</td>
                                 ");
            WriteLiteral(@"       <td class=""text-c-blue"">$7,856</td>
                                    </tr>
                                </tbody>
                            </table>
...
");
            WriteLiteral(@"                                    <img src=""\\assets\images\avatar-2.jpg"" alt=""user image"" class=""img-radius profile-img"">
                                </div>
                            </div>
                            <div class=""col"">
                                <h6 class=""m-b-5"">John Deo</h6>
                                <p class=""text-muted m-b-0"">متن ساختگی جهت تست این قسمت</p>
            ...
            WriteLiteral(@"               </div>
                        ...
                        <div class=""row m-b-25"">
                            ...
                            <div class=""col"">
                                <h6 ");
            WriteLiteral(@"class=""m-b-5"">John Deo</h6>
                                <p class=""text-muted m-b-0"">متن ساختگی جهت تست این قسمت.</p>
                                <p class=""text-muted m-b-0""><i class=""feather icon-clock m-r-10""></i>2 min ago</p>
                            </div>
                        </div>
                        <div class=""row m-b-5"">
                            ...
                            <div class=""col"">
                                ...
                                <p class=""text-muted m-b-0"">متن ساختگی جهت تست این قسمت.</p>
                    ");
            WriteLiteral(@"            <p class=""text-muted m-b-0""><i class=""feather icon-clock m-r-10""></i>2 min ago</p>
                            </div>
                        </div>
                    ...
                    <div class=""card-header"">
                        ...
                        <div class=""card-header-right"">
                            <ul class=""list-unstyled card-option"">
                                ...
                                <li><i class=""fa fa-minus minimize-");
                                                    ...
                                                    <td class=""b-none"">
                                                        <a href=""#!"" class=""align-middle"">
                                                            ...
                                                            <div class=""d-inline-block"">
                                                                <h6>Jeny William</h6>
     ");
            WriteLiteral(@"                                                           <p class=""text-muted m-b-0"">Graphic Designer</p>
                                                            </div>
                                                        </a>
                                                    </td>
                                                </tr>
            ...
            <div class=""col-xl-6 col-md-12"">
             ...
             ");
            WriteLiteral(@"           <div class=""col-sm-4 bg-c-lite-green user-profile"">
           ...
           ");
            WriteLiteral(@"                             <h6 class=""text-muted f-w-400""><a href=""..\..\..\cdn-cgi\l\email-protection.htm"" class=""__cf_email__"" data-cfemail=""3a505f54437a5d575b535614595557"">[email&#160;protected]</a></h6>
                                    </div>
                                    <div class=""col-sm-6"">
